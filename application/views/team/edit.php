  ...
  <div class="content-wrapper">
    ...
    <div class="col-md-3">
        ...
        <div class="col-md-6">
          ...
          <form action="<?php echo base_url(); ?>c_team/update/<?php echo "$id" ?>" method="post" enctype="multipart/form-data">
          <div class="box">
            ...
            <div class="box-body">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <textarea type="text" class="form-control" id="bio" name="bio" placeholder="Masukkan bio"><?php echo $bio ?></textarea>
                </div>
