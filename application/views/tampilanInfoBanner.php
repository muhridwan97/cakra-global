  ...
  <div class="content-wrapper">
    ...
    <div class="col-md-3">
        ...
        <div class="col-md-6">
          ...
          <form action="<?php echo base_url(); ?>c_admin/editWisata/<?php echo "$id" ?>" method="post" enctype="multipart/form-data">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Info Banner</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <div class="box-body">
...
function initMap() {
  // The location 
  var lokasi = {lat: <?php echo $latitude ?>, lng: <?php echo $longitude ?>};
  // The map, centered 
  var map = new google.maps.Map(
      document.getElementById('map'), {zoom: 13, center: lokasi});
  // The marker, positioned 
  var marker = new google.maps.Marker({position: lokasi, map: map});
}
    </script>
    <script async defer
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyC60OOP4K0aTd51iNkCPbaeOg6t5i9owy0">
    </script>
    <!-- google maps api -->
</body>
</html>
