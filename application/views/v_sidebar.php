            ...
            <li class="treeview <?php echo in_array($sidebar, $active_values) ? 'active' : '' ; ?>">
                ...
                <ul class="treeview-menu"
                    ...
                    <li class="<?php echo $sidebar == 'plb' ? 'active' : '' ; ?>">
                        <a href="<?php echo base_url();?>c_admin/layananKami/plb"><i class="fa fa-circle-o"></i> PLB (Pusat Logistik Berikat)</a>
                    </li>
                    <li class="<?php echo $sidebar == 'freight_forwarding' ? 'active' : '' ; ?>">
                        <a href="<?php echo base_url();?>c_admin/layananKami/freight_forwarding"><i class="fa fa-circle-o"></i> Freight Forwarding</a>
                    </li>
                    <li class="<?php echo $sidebar == 'custome_handling' ? 'active' : '' ; ?>">
                        <a href="<?php echo base_url();?>c_admin/layananKami/custome_handling"><i class="fa fa-circle-o"></i> Custome Handling</a>
                    </li>
                    <li class="treeview <?php echo in_array($sidebar, $active_warehouse) ? 'active' : '' ; ?>">
                        ...
                        <ul class="treeview-menu" style="display: <?php echo in_array($sidebar, $active_warehouse) ? 'block' : 'none' ; ?>;">
                            <li class="<?php echo $sidebar == 'open_yard_jakarta_umum' ? 'active' : '' ; ?>">
                                <a href="<?php echo base_url();?>c_admin/layananKami/open_yard_jakarta_umum"><i class="fa fa-circle-o"></i> Open Yard Jakarta Umum</a>
                            </li>
                            <li class="<?php echo $sidebar == 'gudang_plb_jakarta' ? 'active' : '' ; ?>">
                                <a href="<?php echo base_url();?>c_admin/layananKami/gudang_plb_jakarta"><i class="fa fa-circle-o"></i> Gudang PLB Jakarta</a>
                            </li>
                            <li class="<?php echo $sidebar == 'gudang_plb_surabaya' ? 'active' : '' ; ?>">
                                <a href="<?php echo base_url();?>c_admin/layananKami/gudang_plb_surabaya"><i class="fa fa-circle-o"></i> Gudang PLB Surabaya</a>
                            </li>
                            <li class="<?php echo $sidebar == 'gudang_umum_surabaya' ? 'active' : '' ; ?>">
                                <a href="<?php echo base_url();?>c_admin/layananKami/gudang_umum_surabaya"><i class="fa fa-circle-o"></i> Gudang Umum Surabaya</a>
                            </li>
                        </ul>
                    </li>
                    <li class="<?php echo $sidebar == 'project_logistic' ? 'active' : '' ; ?>">
                        <a href="<?php echo base_url();?>c_admin/layananKami/project_logistic"><i class="fa fa-circle-o"></i> Project Logistic</a>
                    </li>
                    <li class="<?php echo $sidebar == 'trucking' ? 'active' : '' ; ?>">
                        <a href="<?php echo base_url();?>c_admin/layananKami/trucking"><i class="fa fa-circle-o"></i> Trucking</a>
                    </li>
                </ul>
            </li>
            <!--PAGE GUIDE -->
