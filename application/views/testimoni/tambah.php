  ...
  <div class="content-wrapper">
    ...
    <div class="col-md-3">
        ...
        <div class="col-md-6">
          ...
          <!-- /.box -->
          <form action="<?php echo base_url(); ?>c_testimoni/save" method="post" enctype="multipart/form-data">
          <div class="box">
            ...
            <div class="box-body">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="jabatan" value="" name="jabatan" placeholder="Masukkan jabatan"> 
                </div>

                <div class="form-group">
                  <label for="testimoni">Testimoni</label>
                  <textarea type="text" class="form-control" id="testimoni" value="" name="testimoni" placeholder="Masukkan testimoni"></textarea>
                </div>
