      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Data Priangan</h3>
              
            </div>
            <div class="box-header">
              <a href="<?php echo base_url();?>c_admin/tampilanTambahBanner">
              <button type="button" class="btn  btn-success btn-lg"><i class="fa fa-plus"> </i>Tambah Banner</button>
              </a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
        ...
        ?>
                <tr data-id="<?php echo "$a[id]"?>">
                  <td><?php echo $i++;?></td>
                  <td>
                    <img src="<?php echo base_url();?>/assets/images/foto/<?php echo "$a[fotoBanner]"?>" class="" alt="User Image" width="150px" height="150px">
                  </td>
                  <td><?php echo "$a[namaBanner]" ?>
                  </td>
                  <td><div class="btn-group">
                    <div>
                    <a href="<?php echo base_url(); ?>c_admin/tampilanInfoBanner/<?php echo "$a[id]" ?>" type="button" class="btn btn-info btn-flat"><i class="fa fa-info">Detail</i></a>
                    </div>
                    <div>
                    <a href="<?php echo base_url(); ?>c_admin/tampilanEditBanner/<?php echo "$a[id]" ?>" type="button" class="btn btn-warning btn-flat"><i class="fa fa-edit">Edit</i></a>
                    </div>
                    <div>
                    <button type="button" class="btn btn-danger btn-flat hapus-member" id="hapus" data-nama = "<?php echo "$a[namaBanner]"?>" data-id="<?php echo "$a[id]"?>" ><i class="fa fa-trash">Hapus</i></button>
                    </div>
                  </div></td>
