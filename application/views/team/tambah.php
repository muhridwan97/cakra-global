  ...
  <div class="content-wrapper">
    ...
    <div class="col-md-3">
        ...
        <div class="col-md-6">
          ...
          <!-- /.box -->
          <form action="<?php echo base_url(); ?>c_team/save" method="post" enctype="multipart/form-data">
          <div class="box">
            ...
            <div class="box-body">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <textarea type="text" class="form-control" id="bio" value="" name="bio" placeholder="Masukkan bio"></textarea>
                </div>
