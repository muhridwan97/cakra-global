  ...
  <div class="content-wrapper">
    ...
    <div class="col-md-3">
        ...
        <div class="col-md-6">
          ...
          <form action="<?php echo base_url(); ?>c_testimoni/update/<?php echo "$id" ?>" method="post" enctype="multipart/form-data">
          <div class="box">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="jabatan">Jabatan</label>
                   <input type="text" class="form-control" id="jabatan" value="<?php echo $jabatan ?>" name="jabatan" placeholder="Masukkan jabatan" > 
                </div>

                <div class="form-group">
                  <label for="testimoni">Testimoni</label>
                  <textarea type="text" class="form-control" id="testimoni" name="testimoni" placeholder="Masukkan testimoni"><?php echo $testimoni ?></textarea>
                </div>
