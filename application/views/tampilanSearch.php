	...
	<nav class="navbar navbar-default">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav navbar-right ">
				<li><a class="hvr-underline-from-center active" href="<?php echo base_url();?>">Home</a></li>
...
<section class="subscribe" id="subscribe">
	<div class="container">
		<h3 class="heading">Cari Wisata Keinginan Anda</h3>
		<form action="<?php echo base_url(); ?>c_web/search" method="post" class="newsletter">
			<input class="email" type="text" name="keyword" placeholder="Masukkan nama wisata " >
			...
			<div class="package_top_grid">
				...
				<div class="col-md-6">
					<div class="packages_right">
						<h3><?php echo "$a->namaWisata" ?></h3>
						<p><br><br><br>
							Diposting pada tanggal <?php echo "$a->tanggal" ?>
						</p>
						<a href="<?php echo base_url();?>c_web/tampilanDetailWisata/<?php echo "$a->idWisata"?>">Read More <span class="fa fa-long-arrow-right"></span></a>
					</div>
				</div>
				<div class="clearfix"></div>
			</div>
