...
<section class="about" id="about">
	<div class="container">
		<h3 class="heading"><?php echo $namaGuide ?></h3>
		<div class="col-md-5 about_left">
			<img src="<?php echo base_url(); ?>assets/images/foto/guide/<?php echo $fotoGuide ?> " width="500px" height="500px">
		</div>
		<div class="col-md-7 about_right">
			
			<h3>Email &emsp;&emsp;&emsp;&emsp;   &ensp;: <?php echo $emailGuide ?></h3>
			<h3>No. Telepon &emsp;: <?php echo $notelpGuide ?></h3>
			<h3>Umur  &emsp;&emsp; &emsp;&emsp;&ensp;: <?php echo $umurGuide ?></h3>
			<h3>Alamat &emsp; &emsp;&emsp;&ensp;: <?php echo $alamatGuide ?></h3>
			<ul>
...
function initMap() {
  ...
  var uluru = {lat: -8.430765, lng: 112.635406};
