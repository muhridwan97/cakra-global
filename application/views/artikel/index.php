      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-header">
              <a href="<?php echo base_url();?>c_artikel/tambah/">
        ...
        ?>
                <tr data-id="<?php echo "$a[id]"?>">
                  ...
                  <td><?php echo "$a[total_akses]" ?>
                  </td>
                  <td><?php echo "$a[created_at]" ?>
                  </td>
                  <td><div class="btn-group">
                    <!-- <div>
                    <a href="<?php echo base_url(); ?>c_artikel/detail/<?php echo "$a[id]" ?>" type="button" class="btn btn-info btn-flat"><i class="fa fa-info">Detail</i></a>
                    </div> -->
                    <div>
                    <a href="<?php echo base_url(); ?>c_artikel/edit/<?php echo "$a[id]" ?>" type="button" class="btn btn-warning btn-flat"><i class="fa fa-edit">Edit</i></a>
                    </div>
                    <div>
...
<script>
  ...
  swal({
    ...
    function(){
     $.ajax({
      url:"<?php echo base_url('c_artikel/hapus'); ?>",
      data:{id:id},
      success: function(){
