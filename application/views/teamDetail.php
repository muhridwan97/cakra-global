...
<head>
    ...
    <meta name="description"
        content="PT Cakra Global Logistik didirikan pada tahun 2024 dengan komitmen untuk menjadi mitra terdepan dalam solusi logistik global.">
    <meta name="keywords"
        content="Cakra Global Logistik,PLB, PLB murah, solusi impor, kebutuhan proses PI, pengurusan PI, PLB alat berat, PLB industri, gudang umum open yard, konsultasi import, Pusat Logistik Berikat, Freight Forwarding, Warehousing,Custom Handling, Project Logistik, Trucking">
    ...
    <!-- Template Stylesheet -->
    <!-- Whatsapp -->
    <a href="https://api.whatsapp.com/send?phone=+6285770552864&text=Hello%20Cakra%20Global%20Logistik" class="float"
        target="_blank">
...
<body>
                ...
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu border-light m-0">
                            <a href="<?php echo base_url(); ?>c_web/layananKami/freight_forwarding"
                                class="dropdown-item">Freight Forwarding</a>
                            <a href="<?php echo base_url(); ?>c_web/layananKami/custome_handling"
                                class="dropdown-item">Custom Handling</a>
                            <a href="<?php echo base_url(); ?>c_web/warehouse" class="dropdown-item">Warehousing</a>
                            <a href="<?php echo base_url(); ?>c_web/layananKami/project_logistic"
                                class="dropdown-item">Project Logistic</a>
                            <a href="<?php echo base_url(); ?>c_web/layananKami/trucking"
                                class="dropdown-item">Trucking</a>
    ...
    <!-- Team Start -->
    <section class="news-section section-padding wow fadeInUp" data-wow-delay="0.1s" id="team" style="margin-top:100px">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8 blog-content">
                    <div class="row mb-5">
                        <div class="col-lg-6">
                            <figure><img src="<?php echo base_url(); ?>assets/images/foto/<?=$team['foto']?>" alt="Image" class="img-fluid">
                                <h5><?=$team['nama']?></h5>
                            </figure>
                            <figcaption><?=$team['jabatan']?></figcaption>
                            </figure>
                        </div>
        ...
        <div class="col-12 d-flex flex-column align-items-center">
            <div class="col-lg-3 col-sm-6 d-flex flex-column">
                <a href="<?php echo base_url(); ?>#team-section" class="btn smoothscroll btn-primary">Kembali</a>
            </div>
        </div>
    </section>
    <!-- team End -->
