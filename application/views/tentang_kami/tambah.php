  ...
  <div class="content-wrapper">
    ...
    <div class="col-md-3">
        ...
        <div class="col-md-6">
          ...
          <!-- /.box -->
          <form action="<?php echo base_url(); ?>c_admin/save_tentang_kami" method="post" enctype="multipart/form-data">
          <div class="box">
            ...
            <div class="box-body">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="nama" value="" name="nama" placeholder="Masukkan nama foto"> 
                </div>
