...
<section class="about" id="about">
	<div class="container">
		<?php
	          foreach ($wisata as $a) {
	        ?>
		<h3 class="heading"><?php echo "$a[namaWisata]"?></h3>
		<div class="col-md-5 about_left">
			<img src="<?php echo base_url(); ?>assets/images/foto/<?php echo "$a[foto]"?> " width="500px" height="500px">
		</div>
		<div class="col-md-7 about_right">
			<h3>Welcome to our road travel</h3>
			<h4>Enjoy your dream vocation with us. Our Road travel is Safe way to reach your destination</h4>
			<p><?php echo "$a[preview]"?></p>
			<ul>
		...
		<h3 class="heading">Services</h3>
			<div class="w3-services-grids">
				<div class="col-md-3 w3-services-left-grid">
					<h4>Road Travel</h4>
					<p>Lorem ipsum dolor sit amet, amet consectetur adipisci ngelit. Ines euismod faucibus quam, a sodales er osplacerat vitae. Sed pretium fermentum luctus. Nunc at lectus ut ex blandit egestas. Pellent esque sed erat at diam lacinia accumsan. </p>
					<div class="more">
						<a href="#">Know more</a>
					</div>
				</div>
		  ...
		  <div class="team-row">
			...
			<div class="col-md-3 team-grids">
				...
				<div class="team-img">
					...
					<img class="" src="<?php echo base_url();?>assets/images/foto/galeri/<?php echo "$a[foto1]"?>" alt="" width ="350px" height="400px">
					<div class="captn">
			...
			<div class="col-md-3 team-grids">
				...
				<div class="team-img">
					...
					<img class="" src="<?php echo base_url();?>assets/images/foto/galeri/<?php echo "$a[foto2]"?>" alt="" width ="350px" height="400px">
					<div class="captn">
			...
			<div class="col-md-3 team-grids">
				...
				<div class="team-img">
					...
					<img class="" src="<?php echo base_url();?>assets/images/foto/galeri/<?php echo "$a[foto3]"?>" alt="" width ="350px" height="400px">
					<div class="captn">
			...
			<div class="col-md-3 team-grids">
				...
				<div class="team-img">
					...
					<img class="" src="<?php echo base_url();?>assets/images/foto/galeri/<?php echo "$a[foto4]"?>" alt="" width ="350px" height="400px">
					<div class="captn">
...
function initMap() {
  ...
  <?php
	          foreach ($wisata as $a) {
	        ?>
  var uluru = {lat: <?php echo "$a[latitude]" ?>, lng: <?php echo "$a[longitude]" ?>};
  ...
  var marker = new google.maps.Marker({position: uluru, map: map});
    ...
    <script async defer
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyC60OOP4K0aTd51iNkCPbaeOg6t5i9owy0&callback=initMap">
    </script>
    <!-- google maps api -->
	<!-- script for fonts --
		<script>
