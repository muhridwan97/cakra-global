...
<html lang="en">
<head>
<title>Wisata Bajulmati</title>
<!-- Meta tag Keywords -->
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta charset="UTF-8">
<meta name="keywords" content="Macam - macam tempat wisata di sekitar daerah desa bajulmati, Malang." />
...
<div class="header">
	<nav class="navbar navbar-default">
		<div class="navbar-header">
			...
			<h1><a href="<?php echo base_url();?>">Wisata Bajulmati</a></h1>
		</div>
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav navbar-right ">
				...
				<li><a href="#packages" class="hvr-underline-from-center scroll">Travel</a></li>
...
<section class="subscribe" id="subscribe">
	<div class="container">
		<h3 class="heading">Cari Wisata dan Pemandu Disini</h3>
		<form action="<?php echo base_url(); ?>c_web/search" method="post" class="newsletter">
			<input class="email" type="text" name="keyword" placeholder="Masukkan nama wisata atau pemandu " >
			<input type="submit" class="submit" name="search_submit" value="Cari">
		</form>
	</div>
</section>
<!-- Search section -->
...
<section class="about" id="about">
	<div class="container">
		<h3 class="heading">Tentang Bajulmati</h3>
		<div class="col-md-5 about_left">
			<img src="<?php echo base_url();?>assets/images/20180702_103010.jpg " width="500px" height="500px">
		</div>
		<div class="col-md-7 about_right">
			<h3>Selamat Datang di Wisata Bajulmati</h3>
			<h4></h4>
			<p>Pantai bajulmati adalah salah satu dari beberapa pantai yang ada di garis pantai selatan yang beralamat di Jalan Lintas Selatan RT 42 RW 05 Bajulmati, Gajahrejo, Malang dan terletak di seberang dusun bajulmati. Nama pantai ini (Bajulmati) diambil sebab pernah ada buaya yang mati di pantai ini.

 </p>
			<p>Pantai Bajulmati memiliki pasir yang putih yang di kelilingi oleh batuan karang. yang membuatnya khas adalah karang yang ada disini berbentuk buaya. Banyak juga terdapat gazebo gazebo kecil untuk tempat bersantai bersama rekan ata keluarga.
Untuk tiket masuk sendiri, cukup membayar 400 rupiah kita sudah bisa masuk untuk menikmati wisata alam yang ada di pantai bajulmati. Dengan beragam fasilitas seperti banyaknya warung makan, homestay dengan harga yang terjangkau, toilet, lahan parkir, dan juga terdapat beberapa stand untuk berfoto dibagian pintu masuk dan dalam pantai.</p>
			<!-- <ul>
...
<section class="team-section" id="team">
	<div class="container">
		<h3 class="heading">Pemandu Kami</h3>
		  <div class="team-row">
		  	<?php
	          foreach ($guide as $a) {
	        ?>
	        <a href="<?php echo base_url();?>c_web/tampilanDetailGuide/<?php echo "$a[idGuide]" ?>">
			<div class="col-md-3 team-grids">
				...
				<div class="team-agile">
					<h4><?php echo "$a[namaGuide]" ?></h4>
					<h5>Umur = <?php echo "$a[umurGuide]" ?></h5>
					<h5>No. Telepon(WA) = <?php echo "$a[notelpGuide]" ?></h5>
				</div>
				</a>
			</div>
...
<section class="packages" id="packages">
	<div class="container">
		<h3 class="heading">Wisata Bajulmati</h3>
			<?php
	          foreach ($wisata as $b) {
	        ?>
			...
			<div class="package_top_grid">
				...
				<div class="col-md-6">
					<div class="packages_right">
						<h3><?php echo "$b[namaWisata]" ?></h3>
						<h4></h4>

						<p><br><br>
							Diposting pada tanggal <?php echo "$b[tanggal]" ?>
						</p>
						<a href="<?php echo base_url();?>c_web/tampilanDetailWisata/<?php echo "$b[idWisata]" ?>">Read More <span class="fa fa-long-arrow-right"></span></a>
					</div>
				</div>
				<div class="clearfix"></div>
			</div>
	...
	<div class="container">
		...
		<div class="contact-agileinfo">
			...
			<div class="col-md-5 contact-left">
				<div class="address">
					<h5>Address:</h5>
					<p><i class="glyphicon glyphicon-home"></i> Kmome St, NY 10002, Canada.</p>
				</div>
				<div class="address address-mdl">
					<h5>Phones:</h5>
					<p><i class="glyphicon glyphicon-earphone"></i> +14 999 888 7773</p>
	...
	<div class="container">
		...
		<div class="footer-agilem">
			<div class="col-sm-8 col-xs-9 copy-w3lsright">
				<p>© 2018 Wisata Bajulmati. All rights reserved <!-- | Design by <a href="http://w3layouts.com"> W3layouts. --></a></p>
			</div>
...
function initMap() {
  // The location 
  var lokasi = {lat: -8.430765, lng: 112.635406};
  // The map, centered 
  var map = new google.maps.Map(
      document.getElementById('map'), {zoom: 8, center: lokasi});
  // The marker, positioned 
  var marker = new google.maps.Marker({position: lokasi, map: map});
}
    </script>
    <script async defer
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCU1ObcG49Rr-xr6VU7tcluykIni_0fNUE">
    </script>
    <!-- google maps api -->
